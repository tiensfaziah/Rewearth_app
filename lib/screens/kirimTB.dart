...
class KirimTBUniqloScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ✅ Konten scrollable dalam SafeArea
      body: SafeArea(
        child: SingleChildScrollView(
          padding: const EdgeInsets.only(bottom: 60), // ruang agar tidak tabrakan dengan tombol
          child: Container(
...
// ✅ Komponen tombol kirim di bawah
...
// ✅ Komponen kartu lokasi drop point
